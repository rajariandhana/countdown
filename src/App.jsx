    ...
    <main className='flex flex-col items-center justify-center gap-y-2 font-mono'>
      ...
      <footer className='fixed bottom-4 text-red-500 flex gap-4 text-sm items-center'>
        ...
        <a href="https://github.com/rajariandhana/countdown" target="_blank" >
          <svg className="w-6 h-6 text-red-500 funny-rotate" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
